...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 09 Janvier 2017 à 09:09
...
--
-- Contenu de la table `distributions`
--
...
--
ALTER TABLE `distributions`
  ADD CONSTRAINT `distributions_ibfk_1` FOREIGN KEY (`idacteur`) REFERENCES `acteurs` (`id`),
  ADD CONSTRAINT `distributions_ibfk_2` FOREIGN KEY (`idfilm`) REFERENCES `films` (`id`);
